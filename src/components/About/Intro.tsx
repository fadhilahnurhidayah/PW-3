...
function Intro() {
  const line1 = "Fadhilah";
  const line2 = "Nurhidayah";
    ...
    <section className="">
      <div className="flex justify-center mt-[8vh]">
        <div className="w-[85%] sm:w-[70%] lg:w-[65%] flex justify-center items-center flex-col">
          ...
          >
            <Paragraph
              text="If Your Only Tool Is a Hammer Then Every Problem Looks Like a Nail"
              className="text-center"
            />
            <Paragraph text="- Abraham Maslow" className="text-right mt-2" />
          </motion.div>
        </div>
      </div>
    </section>
