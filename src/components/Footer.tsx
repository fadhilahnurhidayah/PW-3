...
function Footer() {
  ...
  const links = [
    ...
    {
      title: "linkedIn",
      href: "https://www.linkedin.com/in/fadhilah-nurhidayah-b3a45b27b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      title: "instagram",
      href: "https://www.instagram.com/fdlaanyy?igsh=dGY5bHRkZjUyNG1q",
    },
  ];
