          ...
          >
            <div className="w-[80%] xs:w-full">
              <div className="w-[90%] sm:w-[80%] md:w-[60%]">
                <Paragraph text="I love data science because it combines technology, creativity, and problem-solving to uncover valuable insights from data. It allows us to transform raw information into meaningful knowledge that can help businesses and society make better decisions. The process of analyzing patterns, building models, and predicting outcomes excites me, especially when small pieces of data come together to create powerful solutions." />
              </div>
              <div className="mt-3">
